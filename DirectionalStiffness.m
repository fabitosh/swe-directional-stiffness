...
plot2DStiffness(computeSmoothed2DStiffness(pcl_0deg, 3)); % Only look at one scan
compareStiffnessSurf(pcl_0deg, pcl_90deg, 3); % Compare 0 and 90 degree scans
...
subplot(244)
surf(computeSmoothed2DStiffness(pcl_0deg, 3))
view(0,90)
subplot(248)
surf(computeSmoothed2DStiffness(pcl_90deg, 3))
view(0,90)